...
def input args
  ...
  if args.inputs.controller_one.left_analog_x_perc && args.state.player.y > args.state.bridge_top
    args.state.player.dx = 5 * args.inputs.controller_one.left_analog_x_perc
  elsif args.inputs.controller_one.left_analog_x_perc
    args.state.player.dx = 10 * args.inputs.controller_one.left_analog_x_perc
  end
